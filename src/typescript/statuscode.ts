...
/**
 * gRPC Status Codes
 * See: https://github.com/grpc/grpc/blob/master/include/grpcpp/support/status_code_enum.h
 */
 ...
 */
export function fromHttpStatus(httpStatus: number): StatusCode {
  switch (httpStatus) {
    case 200:
 ...
 * the mapping is not 1:1. Also see {@link StatusCode.fromHttpStatus}.
 * @param statusCode GRPC Status Code
 * @return HTTP Status code
 */
export function getHttpStatus(statusCode: StatusCode): number {
  switch (statusCode) {
    case StatusCode.OK:
      return 200;
 ...
 * @param statusCode GRPC Status Code
 * @return the human readable name for the status code
 */
export function statusCodeName(statusCode: StatusCode): string {
  switch (statusCode) {
  ...
  // LINT.ThenChange(
  //   :status_codes,
  //   //depot/google3/maps/api/javascript/util/rpc_status.ts
  // )
}
